...
class InventoryEditReport < VarlandPdf
  ...
  def draw_format
    ...
    table = DataTable.new(x: 0.25,
                          ...
                          width: 10.5,
                          height: 6.5625,
                          column_widths: [8, 0.5, 1, 1],
                          headers: ['Material', 'Unit', 'Book Quantity', 'Physical Quantity'],
                          headers_h_align: [:left, :center, :center, :center],
                          header_height: 0.75,
                          header_bg_color: "222222",
                          header_font_color: "ffffff",
                          rows_h_align: [:left, :center, :right, :right],
